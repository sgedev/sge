...
static PHYSFS_Context *currentContext = NULL;
#define searchPath (currentContext->searchPath)
#define writeDir (currentContext->writeDir)
#define openWriteList (currentContext->openWriteList)
#define openReadList (currentContext->openReadList)
...
PHYSFS_DECL PHYSFS_Context *PHYSFS_createContext(void)
{
	PHYSFS_Context *context;

	context = allocator.Malloc(sizeof(PHYSFS_Context));
	if (context == NULL)
		return NULL;
...
PHYSFS_DECL PHYSFS_Context *PHYSFS_currentContext(void)
{
...
PHYSFS_DECL void PHYSFS_deleteContext(PHYSFS_Context *context)
{
	if (context == NULL)
		return;
