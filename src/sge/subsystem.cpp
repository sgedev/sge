...
subsystem::subsystem(uv_loop_t *loop)
...
bool subsystem::feed_event(const SDL_Event *event)
{
	SGE_ASSERT(m_started);
...
bool subsystem::handle_event(const SDL_Event *event)
{
	return false;
}
